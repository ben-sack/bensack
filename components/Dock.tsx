...
function DockItem({ href, label, onClick, children, css: cssProp }: DockItemProps) {
  ...
  const isActive = href?.startsWith('/') && `/${firstSegment}` === href
...
function ThemeToggle() {
  ...
  return (
    <motion.svg
      ...
      color="var(--colors-gray10)" fill="none"
    ...
    >
      ...
      <motion.circle cx="12" cy="12" fill="var(--colors-gray10)" style={{ r }} mask="url(#moonMask)" />
...
function SoundToggle() {
  ...
  return (
    <DockItem
      ...
      css={{ '@mobile': { display: 'none' }, '@touch': { display: 'none' } }}
    >
      <svg width="24" height="24" viewBox="0 0 18 18" fill="none">
        ...
        />
        <path d="M14.3025 3.69751C15.7086 5.10397 16.4984 7.01128 16.4984 9.00001C16.4984 10.9887 15.7086 12.8961 14.3025 14.3025" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" style={{ transition: 'opacity 200ms ease', transitionDelay: soundEnabled ? '150ms' : '0ms', opacity: soundEnabled ? 1 : 0 }} />
        <path d="M11.655 6.34501C12.358 7.04824 12.753 8.00189 12.753 8.99626C12.753 9.99063 12.358 10.9443 11.655 11.6475" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" style={{ transition: 'opacity 200ms ease', transitionDelay: soundEnabled ? '0ms' : '150ms', opacity: soundEnabled ? 1 : 0 }} />
      </svg>
    </DockItem>
  )
}
...
function HomeIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path opacity="0.25" d="M20 18.8V6.63998L13.6514 2.81501C13.0511 2.45333 12.751 2.2725 12.4304 2.20186C12.1469 2.13938 11.8531 2.13938 11.5696 2.20186C11.249 2.2725 10.9489 2.45334 10.3486 2.81501L4 6.64001V18.8C4 19.9201 4 20.4802 4.21799 20.908C4.40973 21.2843 4.71569 21.5903 5.09202 21.782C5.51984 22 6.0799 22 7.2 22H16.8C17.9201 22 18.4802 22 18.908 21.782C19.2843 21.5903 19.5903 21.2843 19.782 20.908C20 20.4802 20 19.9201 20 18.8Z" fill="currentColor" />
      <path fillRule="evenodd" clipRule="evenodd" d="M1.14251 9.5145C1.42665 9.98808 2.04091 10.1416 2.51449 9.85749L12 4.16619L21.4855 9.85749C21.9591 10.1416 22.5733 9.98808 22.8575 9.5145C23.1416 9.04092 22.9881 8.42666 22.5145 8.14251L13.029 2.45121C12.3956 2.07119 11.6044 2.07119 10.971 2.45121L1.4855 8.14251C1.01192 8.42666 0.858357 9.04092 1.14251 9.5145Z" fill="currentColor" />
      <path d="M9 16C9 14.3431 10.3431 13 12 13C13.6569 13 15 14.3431 15 16V22H9V16Z" fill="currentColor" />
    </svg>
  )
}
...
function ResumeIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path opacity="0.25" d="M4 4C4 2.89543 4.89543 2 6 2H14L20 8V20C20 21.1046 19.1046 22 18 22H6C4.89543 22 4 21.1046 4 20V4Z" fill="currentColor" />
...
function CraftIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path opacity="0.25" d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" fill="currentColor" />
...
function PhotosIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path opacity="0.25" d="M3 7C3 5.89543 3.89543 5 5 5H19C20.1046 5 21 5.89543 21 7V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V7Z" fill="currentColor" />
      <path d="M3 15L8 10L12 14L15 11L21 17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  ...
  return (
    ...
    >
      <Box
        ...
        css={{
          '.dark &': {
            background: 'linear-gradient(90deg, rgba(0,0,0,0), $colors$gray6 20%, $colors$gray10 67.19%, rgba(0,0,0,0))',
            opacity: 0.6,
            height: '1px',
            position: 'absolute',
            top: -1,
      ...
      <Box
        css={{
          ...
          width: '100%',
          py: 8,
          '@mobile': { height: '72px', overflowX: 'auto', overflowY: 'hidden' },
        }}
      >
        <MouseContext.Provider value={mouseX}>
          ...
          <DockItem href="mailto:contact@bensack.io" label="Email">
            <MailIcon />
          </DockItem>
